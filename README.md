...
## Problems Solved (75 Total)

### Easy Problems (62 Total)
...
### Hard Problems (0 Total)

| # | Problem | Difficulty |
|---|---------|------------|

### Database (SQL) (2 Total)
...
- `.py` files: Python solutions (72)
- `.java` files: Java solutions (1)
- `.sql` files: SQL solutions (2)
